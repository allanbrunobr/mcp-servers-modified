...
async function getBranches(projectId, repositoryId) {
    try {
        ...
        const response = await axiosInstance.get(`${projectId}/_apis/git/repositories/${repositoryId}/refs?filter=heads&api-version=7.1`);
