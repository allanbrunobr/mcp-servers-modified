...
async function createPullRequest(projectId, repositoryId, sourceBranch, targetBranch, title, description) {
    try {
        ...
        const response = await axiosInstance.post(`${projectId}/_apis/git/repositories/${repositoryId}/pullrequests?api-version=7.1`, {
