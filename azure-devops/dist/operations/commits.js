...
async function getCommits(projectId, repositoryId, branch) {
    try {
        ...
        const response = await axiosInstance.get(`${projectId}/_apis/git/repositories/${repositoryId}/commits?searchCriteria.itemVersion.version=${branch}&api-version=7.1`);
